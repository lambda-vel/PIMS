...
<?php 
  ...
  if (isset($_POST['submit'])){
    ...
    */
    ...
    $login_query = "SELECT * FROM login WHERE username = '$username' AND password = '$secured' AND role_id = 400";
    ...
    if($result == 1){
      ...
      if($row['role_id'] == 400){
        ...
        $_SESSION['customer_name'] = $data['user_name'];
...
<head>
    ...
    <title>Customer Login | X Publishers</title>
