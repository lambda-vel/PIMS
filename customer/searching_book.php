...
<?php
  ...
  //session_start();
  $search_book_name = $_SESSION['search_book_name'];

  $searching_book_query = "SELECT * FROM book WHERE book_name LIKE '%$search_book_name%';";
  $searching_book = mysqli_query($conn, $searching_book_query);
    ...
    <div class="container-fluid flex-row">
      ...
      <div class="d-flex justify-content-end">
        <form class="d-flex" role="search" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
          <input class="form-control me-2" type="search" value="<?php echo $search_book_name;?>" aria-label="Search" name="search_book_name">
      ...
      <div class="d-flex justify-content-start">
        <h3>Searching "<?php echo $search_book_name;?>"</h3>
      </div>
      <br>
