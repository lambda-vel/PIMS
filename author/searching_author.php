...
<?php
  ...
  $searching_book = mysqli_query($conn, $searching_author_query);
    ...
    <div class="container-fluid flex-row">
      ...
      <div class="d-flex justify-content-end">
        <form class="d-flex" role="search" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
          <input class="form-control me-2" type="search" value="<?php echo $search_book_author;?>" aria-label="Search" name="search_book_author">
      ...
      <div class="d-flex justify-content-start">
        <h3>Searching "<?php echo $search_book_author;?>"</h3>
      </div>
      <br>
