  ...
  */
  ...
  if (isset($_POST['submit'])){
    ...
    */
    ...
    $login_query = "SELECT * FROM login WHERE username = '$username' AND password = '$secured' AND role_id = 200";
    ...
    if($result == 1){
      ...
      if($row['role_id'] == 200){
        ...
        $_SESSION['author_name'] = $data['user_name'];
        header('Location: ../index.php');
      }
    } else {
...
<head>
    ...
    <title>Author Login | X Publishers</title>
